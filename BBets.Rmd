...
author: "Nathan AbromovichBrLw(35,2,"
output: 
  html_document:
...
```
The data shows that the 95% confidence interval is `r low` to `r high`  
...
```
Per the data above the fair odds would be 4.4
